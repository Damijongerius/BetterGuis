...
public class KingdomBadgeListManagerStaff implements GuiBehavior {

    GuiManager gm;
    public KingdomBadgeListManagerStaff(GuiManager gm){
        this.gm = gm;
    }
    ...
    public Inventory buildInventory(String prefix, String name) {
        ...
        creator.setItems(new int[]{1, 2, 3, 5, 6, 7}, Items.definedItems.get("space"));
        creator.setItem(4,Items.generateItem("addBadge", Material.ORANGE_STAINED_GLASS_PANE));
