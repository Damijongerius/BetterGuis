...
CREATE TABLE IF NOT EXISTS `trophies`.`PlayerBadge` (
  ...
  INDEX `fk_tp_Player_has_tp_Badge_tp_Badge1_idx` (`tp_Badge_ID` ASC),
  INDEX `fk_tp_Player_has_tp_Badge_tp_Player_idx` (`tp_Player_UUID` ASC),
...
CREATE TABLE IF NOT EXISTS `trophies`.`KingdomBadge` (
  ...
  INDEX `fk_Kingdom_has_tp_Badge_tp_Badge1_idx` (`tp_Badge_ID` ASC),
  INDEX `fk_Kingdom_has_tp_Badge_Kingdom1_idx` (`Kingdom_id` ASC),
